...
#Version: 1.3 Alpha - Work in progress (Very buggy)
#Todo: Add int check,
#Fix reset button.
from tkinter import *
import random
...
class Application(Frame):
    ...
    def create_widgets(self):
        self.inst_lbl = Label(self, text = "Number Guessing Game - 1.3 (GUI Edition)", justify=CENTER)
